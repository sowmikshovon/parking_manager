...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-primary">
		...
		<div class="navbar-collapse collapse" id="collapsingNavbar">
			...
			%>
			<ul class="navbar-nav ml-auto"><button class="btn btn-dark border text-secondary-title text-white py-2 px-3">
	...
	<div class='container' style='margin-top: 10px; padding: 10px;'>
		<form method="POST" action="AddParking" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label for="inputEmail">Owner's Full Name</label> <input type="text"
					class="form-control" name="inputName" required>
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="inputEmail">Owner's Email</label> <input type="email"
						class="form-control" name="inputEmail" required>
				</div>
				<div class="form-group col-md-6">
					<label for="inputContact">Owner's Contact</label> <input type="text"
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					<label for="inputFare">Fare (Tk/hour)</label> <input
			...
			<div class="form-row">
				...
				<div class="form-group col-md-4">
					<label for="inputState">Dist.</label> <input type="text"
