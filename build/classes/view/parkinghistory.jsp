...
<body>
	...
	<div class='container align-items-center' style="">
		<div class='row'>
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/parking_manager","root","root");
			...
			try {
				if(userId != null) {
					...
					while (rs.next()) {
						...
						out.println("<p class='text-primary'>Amount Paid :- " + rs.getString("price") + "Tk");
			...
			try {
				if(userId != null) {
					...
					while (rs.next()) {
						...
						out.println("<br>Fare :- " + rs.getString("fare")+ "Tk");
