...
<body class="bg-light">
	<%
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/parking_manager", "root",
				"root");
					...
					try {
						if (parkingId != null && parkingId != "") {
							statement = con.prepareStatement(
									"SELECT datePlaced, timePlaced, hour, booking.carId, numberPlate, name, price FROM booking INNER JOIN car ON booking.carId = car.carId WHERE booking.parkingId = ? AND completion = 0");
